 ...
 * 
 * $Id: tibjms.h 21731 2006-05-01 21:41:34Z $
 * 
 */
...
typedef TIBEMS_I64                                tibjms_long;
...
/* deprecated:  use tibjmsMsg_GetByteSize */
extern tibjms_int
tibjmsMsg_ByteSize(
    tibjmsMsg           message);
...
/* These are probably not to be used publicly */
extern tibjms_status
tibjmsStreamMsg_GetBytes(
    tibjmsStreamMsg     message,
    void**              bytes,
    tibjms_uint*        byteSize);

extern tibjms_status
tibjmsStreamMsg_SetBytes(
    tibjmsStreamMsg     message,
    const void*         bytes,
    tibjms_uint         byteSize);
