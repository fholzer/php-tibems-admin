{ajax_form id='editqueue' method='post' url='index.php?type=editqueue&amp;f=getSubContent&amp;do=1' callback='form_submit'}
<table>
    <tr>
        <td>Queue Name:</td>
    ...
    <tr>
        ...
        <td><input type="text" name="redelivery" value="{$data->getMrd()}" size="10"/>2-255 times</td>
    </tr>
    <tr>
        <td>Max Bytes:</td>
    ...
    <tr>
        <td>Exclusive:</td>
        <td><input type="checkbox" name="exclusive"{if $data->isExclusive() > 0} checked="checked"{/if}/></td>
    </tr>
    <tr>
